...
public class V_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/gembok2.png"))); // NOI18N
        ...
        jPanel5.setBackground(new java.awt.Color(241, 121, 233));
        ...
        if(validasiInput()==true){
            ...
            try {
                if(m.cekLogin(u)){
                    ...
                    new V_MenuUtama(u.getId(),u.getUser()).setVisible(true);
                    dispose();
                }
                else{
    ...
    private boolean validasiInput(){
        ...
        if (txtUser.getText().isEmpty()||txtPass.getText().isEmpty()) {
             JOptionPane.showMessageDialog(null, "User / Password tidak boleh kosong..!!!");
        }else{
            valid = true;
        }
        return valid;
